...
const CardSemester = ({ semester }: Props) => {
  ...
  const startLocaleDate = new Date(startDate).toLocaleDateString('en-US', dateFormatOptions)
  const endingLocaleDate = new Date(endingDate).toLocaleDateString('en-US', dateFormatOptions)
